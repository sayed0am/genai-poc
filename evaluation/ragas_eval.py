...
from ragas.embeddings import _LlamaIndexEmbeddingsWrapper
...
evaluator_llm = LlamaIndexLLMWrapper(GEN_MODEL)
evaluator_embeddings = _LlamaIndexEmbeddingsWrapper(EMBED_MODEL)
